  ...
  return (
    // <SafeAreaView style={styles.container}>
      <View>
        ...
        <ThemedText style={styles.bodyFirstText}>
          * store owner’s degrees
        </ThemedText>
        </ThemedView>
        ...
        {["Home delivery", "Click & collect", "Delivery partner services"].map(
          (item, index) => (
            <ThemedView key={index} style={styles.listItem}>
              <ThemedView style={styles.checkView}>
                <Ionicons name="checkmark-sharp" size={24} color="#043380" />
        ...
        <ThemedView style={styles.socials}>
          ...
          <TouchableOpacity
            onPress={() => Linking.openURL("https://wa.me/234")}
            activeOpacity={0.8}
          >
            <Image
              source={require("../assets/images/pharm_whatsapp.png")}
            />
          </TouchableOpacity>
          <TouchableOpacity
...
export default PharmStoreOverview;
