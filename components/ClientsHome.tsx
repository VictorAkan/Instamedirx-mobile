...
const ClientsHome: React.FC<ClientsHomeProps> = ({
  toggleCartItem,
  disabledButtons,
}) => {
  ...
  return (
    ...
    >
      ...
      <ThemedText style={styles.sectionSubtitle}>
        View Stories from nearby doctors and pharmacies
      </ThemedText>
      <FlatList
        data={storiesData}
        horizontal
        ...
        <ThemedView style={styles.notificationContainer}>
          ...
          <ThemedView style={styles.notificationRow}>
            <ThemedView style={styles.topPart}>
              <ThemedText style={styles.notTopic}>
                Dr Jane messaged you
              </ThemedText>
              <ThemedText style={styles.notSecs}>5s ago</ThemedText>
            </ThemedView>
            <ThemedText style={styles.notText}>
              {truncateText("Hi Alfred, Dr. Jane just sent you a message", 41)}
            </ThemedText>
          </ThemedView>
        </ThemedView>
      </ThemedView>
      <ThemedView style={styles.mainNotContainer}>
        <ThemedView style={styles.notificationContainer}>
          <ThemedView>
            <Image
              source={require("../assets/images/notpic2.png")}
              style={{
                width: 48,
                height: 48,
              }}
          ...
          <ThemedView style={styles.notificationRow}>
            ...
            <ThemedText style={styles.notText}>
              {truncateText("Hi Alfred, PharmC replied to your message", 41)}
            </ThemedText>
          </ThemedView>
        </ThemedView>
      </ThemedView>
      <ThemedView style={styles.mainNotContainer}>
        <ThemedView style={styles.notificationContainer}>
          <ThemedView>
            <Image
              source={require("../assets/images/notpic3.png")}
              style={{
                width: 48,
                height: 48,
              }}
          ...
          <ThemedView style={styles.notificationRow}>
            ...
            <ThemedText style={styles.notText}>
              {truncateText(
                "Hi Alfred, you have successfully added your card",
                41
              )}
            </ThemedText>
          </ThemedView>
