...
import PharmDrawerMenu from './PharmDrawerMenu';

const PharmacyCard = ({ item, setDrawerVisible }: any) => {
    ...
    >
      ...
      <ThemedView style={styles.pharmHeader}>
        ...
        <ThemedView style={styles.details}>
          ...
          >{`${item.location} | ${item.phone}`}</ThemedText>
        </ThemedView>
...
export default function DocsHome() {
  ...
  const storiesData = [
    ...
    },
    {
      id: "4",
      user: "Goodwill Sto...",
      image: require("../assets/images/doc4.png"),
      storyCount: 3,
    },
    {
      id: "5",
      user: "Tess",
      image: require("../assets/images/doc5.png"),
      storyCount: 1,
    },
  ];
  const pharmacists = [
  ...
  return (
    ...
    >
      ...
      <ThemedText style={styles.sectionSubtitle}>
        View Stories of doctors and pharmacist
      </ThemedText>
      <FlatList
        data={storiesData}
        horizontal
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            onPress={() => setSelectedStory(item.image)}
            activeOpacity={0.9}
          >
      ...
      <FlatList
        ref={flatListRef}
        data={pharmacists}
        renderItem={({ item }) => <PharmacyCard setDrawerVisible={setDrawerVisible} item={item} />}
        keyExtractor={(item) => item.id}
        horizontal
        showsHorizontalScrollIndicator={false}
      ...
      <ThemedView style={styles.appointmentContainer}>
        <Image
          source={require("../assets/images/patientwithfixedappointment1.png")}
      ...
      <ThemedView style={styles.notificationView}>
        <TouchableOpacity activeOpacity={0.8} style={styles.notificationRow}>
          ...
          <ThemedView style={styles.notGview}>
            <ThemedText style={styles.headNot}>
              New appointment added
            </ThemedText>
            <ThemedText style={styles.subNot}>
              {truncateText(
                "Oscar David has been added to your appointment list",
                30
              )}
            </ThemedText>
          </ThemedView>
        ...
        <TouchableOpacity activeOpacity={0.8} style={styles.notificationRow}>
          ...
          <ThemedView style={styles.notGview}>
            ...
            <ThemedText style={styles.subNot}>
              {truncateText(
                "Dr Sandra a payment has been made to your account",
                30
              )}
            </ThemedText>
          </ThemedView>
        ...
        <TouchableOpacity activeOpacity={0.8} style={styles.notificationRow}>
          ...
          <ThemedView style={styles.notGview}>
            ...
            <ThemedText style={styles.subNot}>
              {truncateText("You have a recently canceled appointment", 30)}
            </ThemedText>
          </ThemedView>
          <ThemedText style={styles.timeText}>14:32</ThemedText>
        </TouchableOpacity>
        <TouchableOpacity activeOpacity={0.8} style={styles.notificationRow}>
          ...
          <ThemedView style={styles.notGview}>
            ...
            <ThemedText style={styles.subNot}>
              {truncateText("Your appointment with David is completed", 30)}
            </ThemedText>
          </ThemedView>
          <ThemedText style={styles.timeText}>14:32</ThemedText>
        </TouchableOpacity>
