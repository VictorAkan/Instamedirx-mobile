...
export default function DocsEmailVerification() {
                    ...
                    >
                        ...
                        <ThemedView style={styles.inputContainer}>
                            ...
                            <ThemedView style={styles.buttonView}>
                                <CustomBtn route="/registration_screens/doctors_registration_screens/doctors_details" value="Verify and continue" />
                            </ThemedView>
                        </ThemedView>
                    </Animated.View>
                </GestureDetector>
