...
export default function PharmacistsQualifications() {
  ...
  const addDegree = () => {
    setDegrees([
      ...degrees,
      { id: degrees.length + 1, title: "", institution: "", year: "" },
    ]);
  };
          ...
          >
            <ThemedView style={styles.inputContainer}>
              {certifications.map((cert, index) => (
                <ThemedView
                  key={cert.id}
                  style={{ marginBottom: 10, paddingBottom: 5, gap: 25 }}
                >
                  {/* <Text>Title</Text> */}
                  <RegTextInput
                    value={cert.title}
                  ...
                  <ThemedView style={styles.uploadView}>
                    <ThemedText style={styles.uploadTxt}>
                      Upload certificate/license
                    </ThemedText>
                    <ThemedText style={styles.secondTxt}>
                      ( doc,pdf,jpg,jpeg )
                    </ThemedText>
                    <TouchableOpacity
                      activeOpacity={0.9}
                    ...
                    >
                      ...
                      <ThemedText style={styles.upbtntxt}>
                        Upload file
                      </ThemedText>
                    </TouchableOpacity>
                  </ThemedView>
              ...
              <TouchableOpacity activeOpacity={0.9} onPress={addCertification}>
                <ThemedText style={styles.addCertTxt}>
