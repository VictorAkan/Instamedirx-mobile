...
export default function PharmEmailVerfication() {
                    ...
                    >
                        ...
                        <ThemedView style={styles.inputContainer}>
                            ...
                            <ThemedView style={styles.buttonView}>
                                <CustomBtn route="/registration_screens/pharmacists_registration_screens/pharmacists_details" value="Verify and continue" />
                            </ThemedView>
                        </ThemedView>
                    </Animated.View>
                </GestureDetector>
