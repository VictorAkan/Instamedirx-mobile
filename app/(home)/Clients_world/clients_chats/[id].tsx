...
export default function ClientsChatScreen() {
  ...
  const [messages, setMessages] = useState([
    {
      id: "1",
      text: "Hello Doctor, I’m messaging you because I have a slight issue with my hearing",
      sender: "doctor",
    },
    {
      id: "2",
      text: "What’s wrong? Send a vn or start a video call",
      sender: "user",
    },
    ...
    <SafeAreaView style={styles.container}>
      <ThemedView style={styles.headerView}>
        ...
        <ThemedView style={styles.edgeIcons}>
          <TouchableOpacity
            onPress={() =>
              router.push("/Clients_world/call_screens/audio_call_screen")
            }
            activeOpacity={0.9}
          >
            <MaterialIcons name="call" size={28} color="#0755D4" />
          </TouchableOpacity>
          <Link href="/Clients_world/call_screens/video_call_screen" asChild>
