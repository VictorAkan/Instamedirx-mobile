        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.profileContainer}>
                ...
                <ThemedText style={styles.discipline}>
                    Discipline | Family planning, Menstrual disorder, Reproductive health
                </ThemedText>
                ...
                <View style={styles.tabContainer}>
                    <TouchableOpacity
                        activeOpacity={0.8}
                        style={[styles.tab, activeTab === 'Qualification' && styles.activeTab]}
                        onPress={() => setActiveTab('Qualification')}
                    >
                        <Text style={[styles.tabText, activeTab === 'Qualification' && styles.activeTabText]}>
                            Qualifications
                        </Text>
                    </TouchableOpacity>
