...
const MyProfile = () => {
    ...
    const [address, setAddress] = useState("no 2 Victoria street, Ibeju-lekki, off Epe Expresswuay Lagos State");
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container}>
            ...
            <ThemedView style={styles.avatarContainer}>
                <TouchableOpacity onPress={pickImage} activeOpacity={0.8}>
                    <Image
                        source={{
                            uri: imageUri ?? 'https://randomuser.me/api/portraits/men/75.jpg',
                        }}
                        style={styles.avatar}
                    />
                </TouchableOpacity>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <ThemedView style={styles.valueRow}>
                    {editingName ? (
                        ...
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setEditingName(true)}>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <ThemedView style={styles.valueRow}>
                    {editingContact ? (
                        ...
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setEditingContact(true)}>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <ThemedView style={styles.valueRow}>
                    {editingAddress ? (
                        ...
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setEditingAddress(true)}>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <ThemedView style={styles.valueRow}>
                    {editingDob ? (
                        ...
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setEditingDob(true)}>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <TouchableOpacity onPress={() => setShowGenderPicker(!showGenderPicker)} activeOpacity={0.8}>
                    <ThemedView style={styles.valueRow}>
            ...
            <ThemedView style={styles.infoRow}>
                ...
                <TouchableOpacity onPress={() => setShowLanguagePicker(!showLanguagePicker)} activeOpacity={0.8}>
                    <ThemedView style={styles.valueRow}>
