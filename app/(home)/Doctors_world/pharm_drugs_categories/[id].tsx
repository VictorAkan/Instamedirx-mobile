...
export default function ViewallDetails() {
  ...
  const validCategory = categoryName
        ...
        {!isSearchVisible && (
          <>
            <ThemedView style={styles.leftSide}>
              ...
              <ThemedText style={styles.header}>{category}</ThemedText>
            </ThemedView>
                    ...
                    onPress={() => {
                      router.push({
                        ...
                        params: {
                          ...
                          image: item.image,
                          store: item.store,
                          // disableButton: String(disabledButtons[item.id]),
                  ...
                  >
                    <ThemedText
                      style={[
                        ...
                        {
                          color: docDisabledButtons[item.id]
                            ? "#8F8F8F"
                            : "#fff",
                        },
                      ]}
                    ...
                    <ThemedView style={styles.sideView}>
                      <AntDesign
                        ...
                        size={18}
                        color={
                          docDisabledButtons[item.id] ? "#D6D6D6" : "#0866FF"
                        }
                      />
                    </ThemedView>
                  </TouchableOpacity>
